...
다. 소셜 로그인 시 수집 항목
 ...
 - Apple: 이메일, 이름
 - Kakao: 이메일(제공 시), 이름(닉네임), 프로필 사진(제공 시)
...
회사는 서비스 제공을 위해 다음 외부 서비스를 이용합니다.
 ...
 - Google Sign-In, Apple Sign In, Kakao Login: 소셜 로그인 기능
...
c. Items Collected During Social Login
 ...
 - Apple: Email, name
 - Kakao: Email (if provided), name (nickname), profile photo (if provided)
...
The Company uses the following external services for service provision:
 ...
 - Google Sign-In, Apple Sign In, Kakao Login: Social login features
...
公司为提供服务使用以下外部服务：
 ...
 - Google Sign-In, Apple Sign In, Kakao Login：社交登录功能
