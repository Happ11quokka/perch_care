...
⑤ AI 비전 분석을 위해 업로드된 이미지는 분석 및 기록 보관 목적으로 사용되며, 업로드 후 30일 경과 시 자동 삭제됩니다.
...
회사는 서비스 제공을 위해 다음 외부 서비스를 이용합니다.
 - Perch가 직접 설계·운영하는 AI 모델 서비스: AI 건강 체크 및 백과사전 기능 제공 (반려동물 정보가 분석 목적으로 Perch 운영 인프라에서 처리될 수 있음)
...
5. Images uploaded for AI vision analysis are used for analysis and record-keeping purposes and are automatically deleted 30 days after upload.
...
2) The retention periods are as follows:
 ...
 - Health check images: 30 days after upload
...
The Company uses the following external services for service provision:
 - Perch-designed and operated AI model service: AI health check and encyclopedia features (pet information may be processed on Perch-operated infrastructure for analysis purposes)
...
⑤ 为AI视觉分析上传的图片用于分析及记录保管目的，上传30天后自动删除。
...
6. 外部服务使用
公司为提供服务使用以下外部服务：
 - 由 Perch 直接设计并运营的 AI 模型服务：提供AI健康检查及百科功能（宠物信息可能为分析目的在 Perch 运营的基础设施中处理）
...
''';
  ...
  static const String _marketingKo = '''
마케팅 정보 수신 동의

퍼치케어(이하 "회사")는 이용자에게 유용한 정보를 제공하기 위해 아래와 같이 마케팅 정보를 수집·이용하고자 합니다.
...
5. 동의 거부권 및 불이익
 ...
 - 동의 후에도 앱 설정에서 언제든지 수신을 거부할 수 있습니다.

본 동의는 2026년 3월 7일부터 적용됩니다.
''';

  static const String _marketingEn = '''
Consent to Receive Marketing Communications

Perch Care ("Company") would like to collect and use the following information to provide useful updates to users.

1. Purpose of Collection and Use
 - Notifications about new services and features
 - Event and promotion information
 - Personalized pet health care tips
 - Service usage analysis and improvement

2. Information Collected
 - Email address, nickname
 - In-app usage records (usage frequency, key features used)
 - Device information (push notification token)

3. Retention Period
 - Until withdrawal of marketing consent
...
5. Right to Refuse
 - Consent to receive marketing communications is optional and does not affect your ability to use the service.
 - You can opt out at any time through the app settings.

This consent is effective from March 7, 2026.
''';

  static const String _marketingZh = '''
营销信息接收同意

Perch Care（以下简称"公司"）希望收集和使用以下信息，以便为用户提供有用的信息。
