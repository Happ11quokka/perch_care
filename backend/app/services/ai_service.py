...
_PREMIUM_FORMAT = (
    ...
    "HEADER LANGUAGE RULE — THIS IS MANDATORY:\n"
    "Detect the user's language from their query. Output section headers in THAT language ONLY.\n"
    "Do NOT copy the template literally. Replace each {HEADER} placeholder below with the "
    "correct translation from the dictionary. Output only ONE language per header.\n\n"
    "Header dictionary (select the column matching the user's language):\n"
    "  KO              | EN                    | ZH\n"
    "  가능한 원인       | Possible Causes       | 可能的原因\n"
    "  응급도           | Urgency               | 紧急程度\n"
    "  홈케어           | Home Care             | 家庭护理\n"
    "  병원 방문 필요    | When to See a Vet     | 需要就医的情况\n"
    "  부상 유형        | Injury Type           | 伤害类型\n"
    "  응급 처치        | First Aid             | 急救措施\n"
    "  병원 방문        | Vet Visit             | 就医建议\n"
    "  안전 여부        | Safety                | 安全性\n"
    "  영양 정보        | Nutrition Info        | 营养信息\n"
    "  급여 방법        | Feeding Guide         | 喂食方法\n"
    "  원인 분석        | Cause Analysis        | 原因分析\n"
    "  단계별 방법      | Step-by-Step          | 分步方法\n"
    "  주의사항         | Precautions           | 注意事项\n"
    "  기본 정보        | Basic Info            | 基本信息\n"
    "  관리 포인트      | Care Guide            | 饲养要点\n"
    "  팁              | Tips                  | 小贴士\n\n"
    "Severity labels:\n"
    "  KO: 일반/주의/긴급, 안전/주의/금지\n"
    "  EN: Normal/Caution/Urgent, Safe/Caution/Forbidden\n"
    "  ZH: 一般/注意/紧急, 安全/注意/禁止\n\n"
    "--- TEMPLATES (replace {HEADER} with single-language translation) ---\n\n"
