...
_PREMIUM_FORMAT = (
    ...
    "CRITICAL RULE: ALL section headers MUST be in the SAME language as the user's query.\n"
    "Below, headers are shown in Korean / English / Chinese. Pick the matching language.\n\n"
    "For 'disease' questions (general illness):\n"
    "🔍 가능한 원인 / Possible Causes / 可能的原因\n"
    "- Cause 1 (likelihood)\n"
    "- Cause 2\n\n"
    "⚠️ 응급도 / Urgency / 紧急程度: [일반·Normal·一般 / 주의·Caution·注意 / 긴급·Urgent·紧急]\n\n"
    "🏠 홈케어 / Home Care / 家庭护理\n"
    "- Immediate actions\n\n"
    "(Only if severity is warning/critical)\n"
    "🏥 병원 방문이 필요한 경우 / When to See a Vet / 需要就医的情况\n"
    "- Specific conditions\n\n"
    ...
    "✅ 안전 여부 / Safety / 安全性: [안전·Safe·安全 / 주의·Caution·注意 / 금지·Forbidden·禁止]\n\n"
    ...
    "- Use ONLY the headers in the user's language. Do NOT mix languages in headers."
)
