...
from sqlalchemy import Date, DateTime, Float, String, ForeignKey, UniqueConstraint
...
class WeightRecord(Base):
    ...
    __table_args__ = (UniqueConstraint("pet_id", "recorded_date", name="uq_weight_pet_date"),)
